      ...
      <div className="mb-8">
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <p className="text-gray-600">Enter comprehensive income details as per Pakistani tax law</p>
            </div>
          </div>
          <button
            type="button"
        ...
        {showHelp && (
          <div className="mt-4 p-4 bg-blue-50 border border-blue-200 rounded-lg">
            <h3 className="font-medium text-blue-900 mb-2">Comprehensive Income Help</h3>
            <ul className="text-sm text-blue-800 space-y-1">
              <li>• This form covers all Pakistani tax law income categories from your certificates</li>
              <li>• Enter amounts exactly as shown in your income documents and certificates</li>
              <li>• Each section corresponds to specific Pakistani tax law provisions</li>
              <li>• Subtotal: Sum of all income fields entered</li>
              <li>• Grand Total: Subtotal + Capital Gain (from separate Capital Gain form)</li>
...
export default IncomeFormComprehensive;