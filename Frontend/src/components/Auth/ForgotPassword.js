...
const input = { width: '100%', padding: '11px 12px 11px 38px', borderRadius: 11, border: '1px solid var(--l-border, #cfd6e4)', background: 'var(--surface, #fff)', color: 'var(--content, #1f2533)', fontSize: 15, fontFamily: "'Nunito', sans-serif", outline: 'none', boxSizing: 'border-box' };
